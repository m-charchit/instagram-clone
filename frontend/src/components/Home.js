      ...
      <div className="md:container mx-auto xl:px-44 lg:px-20  space-y-6 ">
        ...
        {posts && (
          <InfiniteScroll
            ...
            next={() => {
              dispatch(fetchPosts(posts.nextPage)).then(() => {
          ...
          >
            <div className="flex flex-col space-y-6 lg:w-2/3 ">
              {posts.docs.length !== 0 ? (
                ...
                <>
                  <p className="text-center m-auto font-semibold text-3xl text-gray-600">
                    No Posts Available
                  </p>
                  <p className="text-center m-auto font-semibold text-gray-600">
                    Users you have followed haven't posted yet. <br />
                    Follow more people to see post
                  </p>
                </>
              )}
            </div>
